...
export function ExerciseRunner({ lesson, lang, nextLessonId }: { lesson: Lesson; lang: LangCode; nextLessonId: string | null }) {
  ...
  function handleDone(correct: boolean) {
    ...
    const recorded = reviewing || current.id in results ? results : { ...results, [current.id]: correct }
    ...
    return (
      <div className="relative mx-auto max-w-md px-5 pb-16 pt-20 text-center">
        ...
        <div className="stagger">
          ...
          <h1 className="display mt-3 text-2xl font-bold text-ink">Lesson complete</h1>
      ...
      <div className="sticky top-[57px] z-10 -mx-5 bg-ground/90 px-5 pb-2 pt-3 backdrop-blur">
        <div className="flex items-center gap-3">
          <div className="h-2.5 flex-1 overflow-hidden rounded-full bg-surface-sunk" role="progressbar"
            aria-valuenow={reviewing ? total : index} aria-valuemin={0} aria-valuemax={total} aria-label="Lesson progress">
